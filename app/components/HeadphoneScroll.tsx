...
export default function HeadphoneScroll({ frames }: HeadphoneScrollProps) {
  ...
  return (
    <section
      ref={containerRef}
      className="relative h-screen w-full px-4 py-4 md:px-8 md:py-6 lg:px-12"
    >
      <div className="relative h-full w-full overflow-hidden rounded-3xl bg-[#050505]">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-6 z-20 flex w-full items-end justify-center">
        ...
        <motion.div
          ...
          className="pointer-events-none absolute left-0 right-0 top-6 z-20 mx-auto flex w-full justify-center"
        >
        ...
        <motion.div
          ...
          className="pointer-events-none absolute inset-0 z-20 flex h-full w-full items-center justify-center text-center"
        >
        ...
        <motion.div
          ...
          className="pointer-events-none absolute inset-0 z-20 flex h-full w-full items-center justify-center text-center"
        >
          <h2 className="text-balance text-2xl font-semibold tracking-tight text-white/90 md:text-4xl">
